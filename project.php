      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-12 ftco-animate text-center mb-5">
          	<p class="breadcrumbs mb-0"><span class="mr-3"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Project</span></p>
            <h1 class="mb-3 bread">All Projects</h1>
          </div>
        </div>
      </div>
    </div>
			...
			<div class="container">
				...
				<div class="row">
					<?php
						...
						{
							$query = mysqli_query($con, "SELECT * FROM project_detail LIMIT $start_from, $limit");
							$row = mysqli_num_rows($query);
		                ...
		                <?php   
					        ...
					        for ($i=1; $i<=$total_pages; $i++) { 
					          if ($i==$pn) { 
					          	if (isset($_GET['st']))
					          	{
					          		$pagLink .= "<li class='active'><a href='project.php?page=".$i."&st=".$_GET['st']."'>".$i."</a></li>"; 	
					          	}
					          	else
					          	{
									$pagLink .= "<li class='active'><a href='project.php?page=".$i."'>".$i."</a></li>";   					          		
					          	}
					          }             
					          else  {
					          	 if (isset($_GET['st']))
					          	{
					          		$pagLink .= "<li><a href='project.php?page=".$i."&st=".$_GET['st']."'>".$i."</a></li>"; 	
					          	}else{
