						 		...
						 		<tr> 
						 			<th scope="row"><?php echo $cnt;?></th> 
										...
										<td><?php  echo $row['Pro_Type'];?></td>
						 				...
						 				<td><img src="<?php echo $row["Index_Image"]; ?>"></td>
						 				<td><?php  echo $row['Pro_Fees'];?></td>
						 				<td><?php  echo $row['Pro_Price'];?></td>
						 				<td><?php  echo cat_nm_fun($row['Cat_Id'],$con);?></td> 
						 				<td><a href="delete_project.php?delid=<?php echo $row['Pro_Id'];?>">Delete</a></td> 
						 				</tr>   
						 				<?php 
											$cnt=$cnt+1;
										}?>
